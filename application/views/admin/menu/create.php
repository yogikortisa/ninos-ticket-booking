...
<?= form_open(admin_url('menu/create'), 'id="login_validation"') ?>
<div class="md-card">
    <div class="md-card-content">
        <h3 class="heading_a">Create Menu</h3>

        <div class="uk-grid" data-uk-grid-margin>
            <div class="uk-width-medium-1-2">
                <div class="uk-form-row">
                    <label>Title</label>
                    <input type="text" name="title" class="md-input" required>
                </div>
            </div>
            <div class="uk-width-medium-1-2">
                <div class="uk-form-row">
                    <label>Link</label>
                    <input type="text" name="link" class="md-input" required>
                </div>
            </div>
            <div class="uk-width-medium-1-2">
                <div class="uk-form-row">
                    <label>Icon</label>
                    <input type="text" name="icon" class="md-input use-material-icon-picker" required>
                </div>
            </div>
            <div class="uk-width-medium-1-2">
                <div class="uk-form-row">
                    ...
                    <input type="text" name="parent" class="md-input" required>
                </div>
            </div>
        </div>
